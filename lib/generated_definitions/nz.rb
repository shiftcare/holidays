    ...
    def self.holidays_by_month
      {
            ...
            {:function => "easter(year)", :function_arguments => [:year], :function_modifier => -1,  :year_ranges => [{:before => 2023}],:name => "Easter Saturday", :regions => [:nz]},
      ...
      6 => [{:wday => 1, :week => 1, :name => "Queen's Birthday", :regions => [:nz]},
            {:mday => 20, :name => "Matariki", :regions => [:nz]}],
